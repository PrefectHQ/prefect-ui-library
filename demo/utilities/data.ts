...
import { Flow, FlowRun, BlockDocument, BlockSchema, TaskRun, Deployment, WorkQueue, BlockType, WorkerPool, WorkerPoolQueue, WorkerPoolWorker, GraphNode } from '@/models'
...
function hydrateGraph(graph: FlowRunGraphMock): FlowRunGraphMock {
  console.log('hydrating graph', graph)
  return {
    id: graph.id,
