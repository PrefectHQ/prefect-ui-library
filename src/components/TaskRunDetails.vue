<template>
  <div class="task-run-details">
    ...
    <p-key-value v-if="taskRun.empiricalPolicy!.retries" label="Retry Delay" :value="secondsToApproximateString(taskRun.empiricalPolicy?.retryDelay ?? 0)" :alternate="alternate" />
