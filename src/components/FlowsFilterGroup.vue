  ...
  <div class="flows-filter-group">
    <div class="flows-filter-group__row">
      ...
      <p-label :label="localization.info.deploymentTags">
        <DeploymentTagsComboBox v-model="filter.flowRuns.tags.name" :empty-message="localization.info.all" :placeholder="localization.info.addTagPlaceholder" class="flows-filter-group__deployment-tags" />
      </p-label>
    </div>
...
<script lang="ts" setup>
  ...
  import { SearchInput, StateNameSelect, WorkPoolCombobox, DeploymentTagsComboBox } from '@/components'
