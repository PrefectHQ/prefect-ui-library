...
export { default as PageHeadingBlockCatalog } from './PageHeadingBlockCatalog.vue'
export { default as PageHeadingBlockCatalogCreate } from './PageHeadingBlockCatalogCreate.vue'
