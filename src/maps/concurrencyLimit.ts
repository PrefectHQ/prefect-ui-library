...
export const mapConcurrencyLimitResponseToConcurrencyLimit: MapFunction<ConcurrencyLimitResponse, ConcurrencyLimit> = function(source: ConcurrencyLimitResponse): ConcurrencyLimit {
