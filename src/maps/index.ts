...
import { mapWorkspaceDashboardFilterToTaskRunsFilter, mapWorkspaceDashboardFilterToTaskRunsHistoryFilter } from '@/maps/dashboard'
...
export const maps = {
  ...
  WorkspaceDashboardFilter: { TaskRunsFilter: mapWorkspaceDashboardFilterToTaskRunsFilter, TaskRunsHistoryFilter: mapWorkspaceDashboardFilterToTaskRunsHistoryFilter },
