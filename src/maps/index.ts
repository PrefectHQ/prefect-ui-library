...
import { mapCollectionFlowResponseToCollectionFlow } from '@/maps/collectionFlow'
...
export const maps = {
  ...
  CollectionFlowResponse: { CollectionFlow: mapCollectionFlowResponseToCollectionFlow },
