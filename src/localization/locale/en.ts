export const en = {
  ...
  error: {
    ...
    activateWorkerPoolQueue: 'Failed to activate worker pool queue',
    ...
    pauseWorkerPoolQueue: 'Failed to pause worker pool queue',
    ...
    updateWorkerPoolQueue: 'Failed to update worker pool queue',
  ...
  success: {
    ...
    activateWorkerPoolQueue: 'Worker pool queue active',
    ...
    pauseWorkerPoolQueue: 'Worker pool queue paused',
    ...
    updateWorkerPoolQueue: 'Worker pool queue updated',
