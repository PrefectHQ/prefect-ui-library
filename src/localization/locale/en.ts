export const en = {
  ...
  error: {
    ...
    activateWorkPool: 'Failed to activate worker pool',
    activateWorkPoolQueue: 'Failed to activate worker pool queue',
    ...
    createWorkPool: 'Failed to create worker pool',
    createWorkPoolQueue: 'Failed to create worker pool queue',
    ...
    pauseWorkPool: 'Failed to pause worker pool',
    pauseWorkPoolQueue: 'Failed to pause worker pool queue',
    ...
    updateWorkPool: 'Failed to update worker pool',
    updateWorkPoolQueue: 'Failed to update worker pool queue',
    updateWorkQueue: 'Failed to update work queue',
  },
  success: {
    activateDeployment: 'Deployment active',
    activateNotification: 'Notification active',
    activateWorkPool: 'Worker pool active',
    activateWorkPoolQueue: 'Worker pool queue active',
    ...
    createWorkPool: 'Worker pool created',
    createWorkPoolQueue: 'Worker pool queue created',
    ...
    pauseWorkPool: 'Worker pool paused',
    pauseWorkPoolQueue: 'Worker pool queue paused',
    ...
    updateWorkPool: 'Worker pool updated',
    updateWorkPoolQueue: 'Worker pool queue updated',
